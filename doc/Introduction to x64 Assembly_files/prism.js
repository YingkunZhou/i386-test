...
(function(){
    ...
    var hook = Prism.plugins.toolbar.hook = function (env) {
        ...
        wrapper.setAttribute('data-component', 'wa_skip_track');
        wrapper.setAttribute('data-component-id', '1');
    ...
    Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
        ...
        function registerClipboard() {
            var clip = new ClipboardJS(linkCopy, {
                'text': function () {
					var trackable = env.code.includes("docker pull");
                    var compName ="code-toolbar-1";
                    if(trackable) {
						try {
  							wap_tms.custom.trackComponentClick(compName, "pull-command");
						} catch(err) {
  							console.log("Error while tracking docker pull command!");
						}
                    } else {
						try {
  							wap_tms.custom.trackComponentClick(compName, "code-snippet");
						} catch(err) {
  							console.log("Error while tracking code-snippet!");
						}
